...
# rekomendmyg = Button(label="Rekomendacijos", button_type="fail", height=20)


def data_update():
	for k in [gervandfm, subalanmiegfm]:
		if k == gervandfm:
			gervandfm = StringFormatter(font_style="bold", text_color="blue")

rekomendmyg.on_click(data_update)
